...
')
     ...
     */ 
         ...
         *
         * @param $shortCode
         * @return \DrH\Mpesa\Library\RegisterUrl 
         * @static 
         */ 
        public static function register($shortCode)
        {
                        /** @var \DrH\Mpesa\Library\RegisterUrl $instance */
                        return $instance->register($shortCode);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function onTimeout($onTimeout = 'Completed')
        {
                        /** @var \DrH\Mpesa\Library\RegisterUrl $instance */
