                    ...
                    <div class="card anime_card">
                        <div class="card-body shadow-lg">
                            ...
                            <form id="register_seller" action{{ route('admin.register') }} method="POST">
                                ...
                                <div class="row mb-2">
                                    <div class="form-group col d-flex align-items-end mb-0">
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="male" name="gender" class="form-check-input" @if(old('gender')) checked @endif value="Male">
                                            <label class="form-check-label" for="male">Male</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="female" name="gender" class="form-check-input" @if(old('gender')) checked @endif value="Female">
                                            <label class="form-check-label" for="female">Female</label>
                                        </div>
                                    </div>
                                    <div class="form-group col">
                                        <label class="anime_input_field">
                                            <input type="tel" id="phone" name="phone"  class="anime_input" value="{{ old('phone') }}" required>
