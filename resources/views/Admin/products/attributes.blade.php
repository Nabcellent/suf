            ...
            <div class="col-6">
                <div class="card crud_table shadow mb-4">
                    <div class="card-header d-flex flex-row align-items-center justify-content-between">
                        ...
                        <button class="btn btn-outline-info" data-toggle="modal" data-target="#add_category">Add Attribute</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-borderless table-hover crud_table" id="categories_table">
                                ...
                                <tr>
                                    ...
                                    <td><%= row.name %></td>
                                    <td>
                                        <% if(Array.isArray(JSON.parse(row.values))) { %>
                                        <%= JSON.parse(row.values).join(", ") %>
                                        <% } else { %>
    ...
    <div class="modal fade" id="add_category" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/products/attributes" method="POST">
