                                                ...
                                                @foreach($product->variations as $variation)
                                                    <tr>
                                                                ...
                                                                @foreach($variation->options as $optionKey => $optionVal)
                                                                    <tr>
                                                                        <td class="d-flex">
                                                                            ...
                                                                            <img id="loader"
                                                                                 src="{{ asset('images/loaders/Gear-0.2s-200px.gif') }}" alt=""
                                                                                 width="30" height="30">
                                                                        </td>
                                                                        <td>
                                                                            <div class="row">
                                                                                <div class="col-4">{{ $optionVal['stock'] }}</div>
                                                                                <div class="col">
                                                                        ...
                                                                        <td>
                                                                            <div class="row">
                                                                                <div class="col-4">{{ currencyFormat($optionVal['extra_price']) }}/-
                                                                                </div>
                                                                                <div class="col">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="#" class="delete-from-table ml-2"
                                                                               data-id="{{ $optionKey }}" data-model="Variation's Option">
                                                        ...
                                                        <td class="d-flex">
                                                            ...
                                                            <a href="#" class="delete-from-table" data-id="{{ $variation['id'] }}"
                                                               data-model="Variation"><h5><i class="fas fa-trash pl-3"></i></h5></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                        ...
                                        <table class="table table-striped table-borderless table-hover crud_table" id="categories_table">
                                            ...
                                            @foreach($product['images'] as $image)
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('/images/products/' . $image['image']) }}" alt="image" class="img-fluid">
                                                    </td>
                                                    <td class="action">

                                                        @if($image['status'])
                                                            <a class="update_status mr-4" data-id="{{ $image['id'] }}" data-model="Product's Image"
                                                               title="Update Status"
                                                               style="cursor: pointer"><i class="fas fa-toggle-on" status="Active"></i></a>
                                                        @else
                                                            <a class=" update_status mr-3" data-id="{{ $image['id'] }}" data-model="Product's Image"
                                                               title="Update Status"
                                                               style="cursor: pointer"><i class="fas fa-toggle-off" status="Inactive"></i></a>
                                                        @endif

                                                        <a href="#" class="delete-from-table" data-id="{{ $image['id'] }}"
                                                           data-model="Product's Image" data-image="{{ $image['image'] }}" title="Remove">
