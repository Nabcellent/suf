...
<div class="modal fade" id="add_variation" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.create.variation') }}" method="POST">
                <div class="modal-header">
...
<div class="modal fade" id="set_price" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.update.extra-price') }}" method="POST">
                @method('PATCH')
                <div class="modal-header">
...
<div class="modal fade" id="add_image_modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.create.product-image') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
...
<div class="modal fade" id="delete_image_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.delete.product-image') }}" method="POST">
                @method('DELETE')
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Delete Product</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
