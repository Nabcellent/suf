            ...
            <div class="row">
                <div class="col-lg-9 col-md-12">
                    <div class="card shadow">
                        <form id="frm_add_user" action="/users" method="POST" enctype="multipart/form-data">
                            <div class="card-header d-flex justify-content-between">
                                <h4 class="m-0 font-weight-bold"><i class="fab fa-opencart"></i> Add <%= userType %></h4>
                            ...
                            <div class="card-footer text-right">
                                ...
                                <button type="submit" class="btn btn-outline-primary">
                                    <i class="fas fa-plus-circle"></i> Create Seller
                                </button>
            ...
            <div class="card crud_table shadow mb-4">
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="/admins" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            All Admins<span class="badge badge-primary badge-pill">14</span>
                        </a>
                        <a href="/sellers" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
