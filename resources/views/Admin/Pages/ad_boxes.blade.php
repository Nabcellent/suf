                ...
                <div class="card crud_box shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <% sliderInfo.adBoxes.forEach((row) => { %>
                            <div class="col-xl-4 col-md-6 card border-0 box shadow-sm">
                                <div class="card-header">
                                    <i class="fas fa-box fa-2x text-gray-300"></i> Box <%= row.number %>: <%= row.title %>
                                    <div class="action">
                                ...
                                <div class="card-body">
                                    <div class="box_url"><%= row.url %></div>
                                    <div class="box_img">
                                        <img src="/images/box_section/<%= row.image %>" alt="<%= row.image %>">
                                    </div>
                                    <div class="box_desc"><%= row.desc %></div>
                                </div>
                            </div>
                            <% }) %>
