        ...
        <div class="col-xl-10 col-lg-12 col-md-9 my-auto p-0 bg-light rounded shadow">
            <div class="row">
                <div class="col-lg-5 d-none d-lg-block">
                    <img src="{{ asset('/images/admin/160-1606471_logo-java.png') }}" alt="login image" class="img-fluid" style="width:100%; height: 100%; object-fit: cover">
                </div>
                <div class="col-lg-7 p-5 overflow-auto" style="max-height: 35rem">
                    <label style="position: absolute; top: 0; left: 0"> <%= admin.user_type %> </label>
                    <div class="row">
                        <div class="col text-center">
                            <h3>Hello <%= admin.last_name %>!</h3>
                        ...
                        <div class="col">
                            <form id="admin_profile_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control border-0" id="email_address" name="email_address"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control border-0" id="phone_number" name="phone_number"
                                               value="" required>
                                    </div>
                                </div>
