                            ...
                            <table class="table table-striped table-borderless table-hover crud_table" id="brands_table">
                                ...
                                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="action">
                                            <?php if($brand['status']): ?>
                                                <a class="update_status mx-2" data-id="<?php echo e($brand['id']); ?>" data-model="Brand" title="Update Status"
                                            ...
                                            <a href="#" class="mx-2 update_brand" title="Modify" data-toggle="modal" data-target="#brand" data-id="<?php echo e($brand['id']); ?>" data-name="<?php echo e($brand['name']); ?>">
                                                <i class="fas fa-pen text-dark"></i>
                                            </a>
                                            <a href="#" class="mx-1 delete-from-table" data-id="<?php echo e($brand['id']); ?>" data-model="Brand" title="Remove">
