...
<header class="header">
    <div class="header_container">
        <div class="dropdown header_image">
            <?php echo e(Str::substr(Str::upper(User()->first_name), 0, 1)); ?>.
            <?php echo e(Str::ucfirst(User()->last_name)); ?>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="<?php echo e(route('admin.orders')); ?>">Orders</a>
