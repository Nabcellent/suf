                        ...
                        <div class="card shadow mx-auto" style="max-width:30rem">
                            <div class="card-header">
                                ...
                                <?php if(session()->has('status')): ?>
                                    <div class="alert alert-info py-1 px-2 mb-1" role="alert">
                            ...
                            <div class="card-body pb-0 anime_card">
                                <form id="forgot_password" class="anime_form" action="<?php echo e(url('/forgot-password')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('/layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nabcellent-7/Desktop/PHP/My Projects/suf-laravel/resources/views/users/forgot_password.blade.php ENDPATH**/ ?>