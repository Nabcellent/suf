                ...
                <div class="row">
                    <?php if(User()->is_admin === 7): ?>
                        <div class="col">
                            ...
                            <img src="<?php echo e(asset('images/illustrations/undraw_pie_chart_6efe.svg')); ?>" alt="">
                        </div>
                    <?php else: ?>
                        <div class="col-lg-5 d-none d-lg-block">
                            <?php if(empty($admin['image'])): ?>
                                <img src="<?php echo e(asset('/images/general/store_logo.jpg')); ?>" alt="login image" class="img-fluid" style="width:100%; height: 100%; object-fit: cover">
                            <?php else: ?>
                        ...
                        <div class="col-lg-7 p-5 overflow-auto" style="max-height: 35rem">
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <h3>Hello <?php echo e($admin['user']['first_name']); ?>!</h3>
                                    ...
                                    <form id="admin_profile_form">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control border-0" id="first_name" name="first_name" value="<?php echo e($admin['user']['first_name']); ?>" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="mb-0" for="last_name">Last Name</label>
                                                <input type="text" class="form-control border-0" id="last_name" name="last_name" value="<?php echo e($admin['user']['last_name']); ?>" required>
                                            </div>
                                        </div>
                                        <div></div>
                                        <div class="form-group">
                                            <label class="mb-0" for="email_address">Email Address</label>
                                            <input type="email" class="form-control border-0" id="email_address" name="email_address" value="<?php echo e($admin['user']['email']); ?>" required>
                                        </div>
                                        <div class="form-group">
