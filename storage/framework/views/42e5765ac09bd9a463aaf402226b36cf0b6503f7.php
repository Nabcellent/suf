                        ...
                        <div class="card-header d-flex justify-content-center">
                            <figure class="figure m-0 profile-image">
                                <?php if(!empty(Auth::user()->image) && file_exists(public_path('/images/users/profile/' . Auth::user()->image))): ?>
                                    <img src="<?php echo e(asset('/images/users/profile/' . Auth::user()->image)); ?>" class="figure-img img-fluid rounded" alt="Profile Picture">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('/images/users/630728-200.png')); ?>" class="figure-img img-fluid rounded" alt="Profile Picture">
                                <?php endif; ?>
                                <figcaption class="figure-caption">
                                    <h5 class="card-title" style="text-decoration: underline"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></h5>
                                </figcaption>
